...
const ABOUT_DESCRIPTION =
  "Jak získáváme a zpracováváme data o českém realitním trhu. Popis výpočtů, sledování cen, aktivních nabídek, ceny za m² a návratnosti pronájmu.";
...
const sections = [
  ...
  { id: "jak-data-ziskavame", label: "Jak data získáváme" },
  { id: "sledovani-cen", label: "Jak funguje sledování cen" },
  { id: "aktivni-neaktivni", label: "Aktivní a neaktivní nabídky" },
  { id: "cena-za-m2", label: "Jak počítáme cenu za m²" },
  {
    id: "navratnost-pronajmu",
    label: "Jak počítáme návratnost pronájmu",
  },
  {
            ...
            <div className="min-w-0">
              <div className="border-b border-dashed py-6 lg:py-10 px-4 lg:px-8">
                <div className="max-w-3xl space-y-4">
                  ...
                  <p className="text-sm leading-7 text-muted-foreground sm:text-base">
                    Tato stránka popisuje, co projekt sleduje, jak pracuje s
                    historií inzerátů a jak interpretuje vývoj cen nemovitostí,
                    nájemní trh, aktivní nabídky a zlevnění nemovitostí. Cílem je
                    nabídnout transparentní metodiku analytického webu, nikoli
                    prezentaci jednotlivých nabídek.
                  </p>
                </div>
              </div>
              ...
              <div className="overflow-hidden">
                ...
                <p>
                  ...
                  trhu. Vedle samotných cen sledujeme také nájmy, cenu za m²,
              ...
              <MethodologySection
                ...
                title="Jak data získáváme"
              >
                <p>
                  Data pocházejí z veřejně dostupných realitních nabídek, které
                  jsou pravidelně automatizovaně zpracovávány. Zaznamenáváme
                  zejména textové a strukturované informace, které jsou potřeba
                  pro analytické vyhodnocení nabídky, cen a lokality.
                </p>
                <p>
                  Při zpracování sjednocujeme názvy lokalit, typy transakcí,
                  kategorie nemovitostí a další atributy tak, aby bylo možné
                  porovnávat data mezi regiony a v čase. Výsledkem nejsou
                  redakčně upravené profily inzerátů, ale datová vrstva určená
                  pro statistické a metodické vyhodnocení.
                </p>
              </MethodologySection>
              ...
              >
                <p>
                  U každé nabídky sledujeme její stav v čase. Pokud se u stejného
              ...
              >
                <p>
                  Za aktivní nabídky považujeme inzeráty, které jsou v aktuálním
              ...
              <MethodologySection
                id="navratnost-pronajmu"
                title="Jak počítáme návratnost pronájmu"
              >
                <p>
                  Orientační hrubou návratnost pronájmu vyjadřujeme počtem let,
                ...
                <p>
                  ...
                  držením a provozem nemovitosti. Výsledek proto chápeme jako
              ...
              <MethodologySection id="omezeni-dat" title="Omezení dat">
                <p>
                  Pracujeme s nabídkovými daty, nikoli s realizovanými prodejními
